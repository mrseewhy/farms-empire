...
function HomePage() {
  useDocumentTitle(
    "Farms Empire | Africa's leading United Nations SDG 2 intervention organization",
  );
  return (
    <main className="min-h-screen">
      ...
      <section className="relative min-h-[70vh] overflow-hidden bg-primary lg:min-h-screen">
        ...
        />
        <div className="absolute inset-0 bg-linear-to-br from-black/80 via-black/50 to-black/20" />
        <div className="absolute inset-0 bg-linear-to-t from-black/60 via-transparent to-transparent" />

        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-[15%] right-[10%] h-32 w-32 rounded-full bg-logo-green/10 blur-3xl animate-[float_8s_ease-in-out_infinite] sm:h-48 sm:w-48 lg:h-64 lg:w-64" />
          <div className="absolute bottom-[20%] right-[15%] h-24 w-24 rounded-full bg-accent/10 blur-2xl animate-[float_10s_ease-in-out_infinite_1s] sm:h-36 sm:w-36 lg:h-48 lg:w-48" />
          <div className="absolute top-[40%] right-[5%] hidden h-32 w-32 rounded-full bg-white/5 blur-xl animate-[float_7s_ease-in-out_infinite_2s] sm:block" />
          <div className="absolute top-[25%] left-[60%] h-10 w-10 rounded-full border border-white/10 animate-[float_6s_ease-in-out_infinite_0.5s] sm:h-16 sm:w-16 lg:h-20 lg:w-20" />
          <div className="absolute bottom-[30%] left-[70%] h-8 w-8 rounded-full border border-logo-green/20 animate-[float_9s_ease-in-out_infinite_1.5s] sm:h-12 sm:w-12 lg:h-16 lg:w-16" />
        </div>
            ...
            <div className="max-w-2xl">
              <FadeIn direction="up" delay={100}>
                <div className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-1.5 backdrop-blur-sm">
                  <span className="h-2 w-2 rounded-full bg-logo-green animate-pulse" />
              ...
              <FadeIn direction="up" delay={200}>
                <h1 className="mt-6 font-display text-5xl font-bold leading-[1.05] text-white sm:text-6xl lg:text-7xl xl:text-[5.25rem]">
                  Communities
                  <br />
                  Grow{" "}
                  <span className="relative inline-block">
                    <span className="text-logo-green">Empires</span>
                    <svg
              ...
              <FadeIn direction="up" delay={300}>
                <p className="mt-6 max-w-xl text-xl font-medium leading-relaxed text-white/80 sm:text-2xl">
                  Africa's leading United Nations SDG 2 intervention
                  organization against hunger and food insecurity.
                </p>
              </FadeIn>
              ...
              <FadeIn direction="up" delay={500}>
                <div className="mt-10 inline-flex items-center gap-4 rounded-2xl bg-white/10 px-5 py-3 backdrop-blur-md">
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="text-[11px] text-white/70">
                      Trusted by 500+ farming families
                    </p>
                  </div>
                </div>
              </FadeIn>
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <FadeIn direction="left">
              <div>
                ...
                <p className="mt-6 text-lg leading-relaxed text-muted-foreground">
                  At Farms Empire, we believe Communities Grow Empires. We
                  partner with individuals, groups, and local communities to
                  build sustainable agricultural powerhouses through expert
                  consultancy, strategic support, collective resources, and the
                  enduring strength of communal farming, to achieve food
                  security across Africa.
                </p>
                <blockquote className="mt-8 rounded-r-xl border-l-4 border-accent bg-accent/5 py-4 pr-6 pl-6">
                  <p className="text-base italic text-foreground/80">
                    "If we want to improve our agricultural sector, we must
                    think of cooperation."
                  </p>
                  <footer className="mt-2 text-sm font-medium text-muted-foreground">
                    - Julius Nyerere, former President of Tanzania and architect
                    of the 'Ujamaa' (Villagisation/Communal Value and
                ...
                <div className="mt-8 flex flex-wrap items-center gap-6">
                  ...
                  <div className="flex items-center gap-3 text-sm text-muted-foreground">
                    ...
                    <span>
                      Headquartered in Nigeria, operating across Africa
                    </span>
                  </div>
                </div>
              </div>
            ...
            <FadeIn direction="right">
              <div className="relative">
                ...
                <div className="absolute -bottom-4 left-4 rounded-xl bg-primary p-4 text-white shadow-xl shadow-primary/20 sm:-bottom-6 sm:-left-6 sm:p-5">
                  <p className="text-2xl font-bold sm:text-3xl">500+</p>
                  <p className="text-xs text-white/80 sm:text-sm">
                    Hectares Under Management
                  </p>
                </div>
                <div className="absolute right-2 top-6 rounded-xl border border-border bg-card p-3 shadow-xl sm:-right-4 sm:top-8 sm:p-4">
                  <div className="flex items-center gap-2 sm:gap-3">
                    <div className="flex h-8 w-8 items-center justify-center rounded-full bg-logo-green/10 sm:h-10 sm:w-10">
                      <svg
          ...
          <FadeIn direction="up">
            <div className="text-center">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
                Hear from the landowners, communities, and investors who have
                transformed their agricultural potential with Farms Empire.
              </p>
            </div>
          </FadeIn>
          <Stagger
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <FadeIn direction="up">
            <div className="text-center">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
                Our services span the entire agricultural value chain, from
                initial consultancy and farm design to active management and
            ...
            <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
              ...
              <div className="text-center lg:text-left">
                ...
                <p className="mt-6 text-lg leading-relaxed text-white/75">
                  ...
                  to work through communal farming, and watch it generate
                  massive returns while you wait for development. Don't let your
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <FadeIn direction="up">
            <div className="text-center">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
                Active communal farming projects across Nigeria and Africa,
                driving food security and economic empowerment.
              </p>
            </div>
          </FadeIn>
          <Stagger
              ...
              >
                <div className="relative aspect-[16/9] overflow-hidden">
                  ...
                  <div className="absolute left-4 top-4">
                    <span className="inline-flex items-center rounded-full bg-logo-green/90 px-3 py-1 text-xs font-semibold text-white backdrop-blur-sm">
                      {project.status}
                    </span>
                  </div>
                </div>
                <div className="flex flex-1 flex-col p-6">
                  <h3 className="line-clamp-2 font-display text-lg font-bold text-foreground group-hover:text-primary transition-colors">
                    {project.title}
                  </h3>
            ...
            <FadeIn direction="left">
              <div>
                <div className="relative">
                  ...
                  <div className="absolute -bottom-6 -left-6 rounded-xl bg-primary p-5 text-white shadow-xl">
                ...
                <div className="mt-8 space-y-4">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-foreground">
                        {siteConfig.contact.address.offices.join(". ")}
                      </p>
                    </div>
                  </div>
                </div>
