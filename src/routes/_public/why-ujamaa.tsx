            ...
            <FadeIn direction="right">
              <div>
                ...
                <p className="mt-6 text-lg leading-relaxed text-muted-foreground">
                  ...
                  owns together, and grows together will always produce more than
                  any individual working alone.
                </p>
                <p className="mt-4 text-lg leading-relaxed text-muted-foreground">
                  Coined and championed by Julius Nyerere, the visionary founding
                  father of Tanzania, Ujamaa was more than a political idea. It
                  was a declaration that Africa's greatest strength has never been
                  its land or its resources alone, it has always been its people,
                  and what those people are capable of when they are united by
                  shared purpose, shared labour, and shared reward.
                </p>
      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {[
              { individual: "Vulnerable", communal: "Resilient", desc: "Where individual farming is vulnerable, communal farming is resilient." },
              { individual: "Limited", communal: "Amplified", desc: "Where individual farming is limited by one person's capital and capacity, communal farming is amplified by the strength of many." },
              { individual: "Feeds a Household", communal: "Feeds a Community", desc: "Where individual farming feeds a household, communal farming feeds a community, and generates the commercial surplus that creates real wealth." },
            ].map((item) => (
              <FadeIn key={item.communal} direction="up">
                <div className="rounded-xl border border-border bg-card p-6 shadow-sm transition-all duration-300 hover:shadow-lg hover:border-primary/20">
                  <div className="flex items-center gap-3">
                    <span className="text-sm text-muted-foreground line-through">{item.individual}</span>
                    <svg className="h-4 w-4 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                    </svg>
                    <span className="text-sm font-bold text-primary">{item.communal}</span>
                  </div>
          ...
          <FadeIn direction="up">
            <div className="mx-auto max-w-7xl text-center">
              <p className="text-lg leading-relaxed text-muted-foreground">
                This is why every farm we build, every partnership we structure,
                and every community we mobilize is anchored in the Ujamaa spirit;
                because we have seen, with our own eyes and on our own farms,
                that when communities grow together, everyone wins. Partners
                earn. Communities prosper. And Africa moves closer to the day
                when hunger is no longer part of its story.
              </p>
            </div>
          </FadeIn>
        </div>
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            <FadeIn direction="right">
              <div>
                ...
                <p className="mt-4 text-lg leading-relaxed text-muted-foreground">
                  And it is why Farms Empire is able to offer investors something
                  rare in African agriculture, a model that is both deeply human
