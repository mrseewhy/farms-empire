export const siteConfig = {
  ...
  projects: [
    ...
    },
    {
      ...
      status: "Active",
      description:
        "Women constitute over 60% of Africa's smallholder farmers yet receive disproportionately less support, resources, and income from agriculture. This programme provides land access, full farm setup, cooperative governance training, and direct market linkages to institutional buyers.",
      impact: [
    ...
    },
    {
      ...
      status: "Ongoing",
      description:
        "Many of Nigeria's most productive agricultural lands are owned by urban professionals and investors who neither live near their land nor have the time or expertise to develop it. A fully managed agricultural partnership that activates idle land, generates returns, and requires zero operational effort from the landowner.",
      impact: [
    ...
    },
    {
      ...
      status: "Active",
      description:
        "The future of African agriculture depends on the next generation. This initiative embeds practical agricultural education in secondary schools and runs structured agripreneurship training for young people, equipping them to launch and manage their first commercial farming enterprises.",
      impact: [
  ...
  testimonials: [
    {
      quote:
        "Before partnering with Farms Empire, my 30 hectares of land sat idle for years. Within the first season, I was earning consistent returns from communal rice farming. It changed my family's financial future.",
    ...
    {
      quote:
        "The community mobilization was unlike anything we experienced before. Farms Empire trained 45 of our farmers in modern techniques, and our yield tripled in just two seasons. This is real empowerment.",
    ...
    {
      quote:
        "As an investor, I wanted sustainable returns without the operational headache. Farms Empire handles everything, from farm setup to market access. My investment has generated 35% annual returns.",
