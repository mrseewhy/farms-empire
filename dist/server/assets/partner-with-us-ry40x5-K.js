						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FadeIn, {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
									...
									children: "Your Land. Our Expertise. One Harvest. Infinite Potential."
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "mt-6 text-lg leading-relaxed text-muted-foreground",
									children: "If you are not earning from your land, someone else is. Your land may be sitting idle, but your wealth does not have to. Partner with Farms Empire today, put your undeveloped land to work through communal farming, and watch it generate massive returns while you wait for development. Don't let your greatest asset sleep, let it grow."
								}),
						...
						children: [
							{
								...
								desc: "You own land in Nigeria or across Africa. It may be awaiting development, caught in planning processes, or simply lying idle. Whatever the reason, idle land is not neutral, it is a daily loss of potential income. Farms Empire will partner with you to activate your land through our communal farming model; managing everything from farm design and community mobilization to harvest operations and commercial sales. You provide the land. We provide everything else. You earn returns. Your land builds value.",
								benefits: [
						...
						children: [
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "flex h-12 w-12 mx-auto items-center justify-center rounded-full bg-primary text-lg font-bold text-primary-foreground",
									children: item.step
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
									className: "mt-4 font-bold text-foreground group-hover:text-primary transition-colors text-sm",
									children: item.title
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
